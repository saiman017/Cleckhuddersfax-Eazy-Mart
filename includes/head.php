...
<body>
    <header>
        <nav id="up-nav">
            <div class="wapper">
                <div class="logo"><a href="../index.php"><img src="../assets/images/icons/logo.png" alt=""
                            id="logo"></a></div>
                <div class="search">
                    <form action="#">
                        <input type="text" placeholder="&nbsp &nbsp&nbsp&nbsp&nbsp&nbsp&nbsp Search product....."
                            name="search">
                        <button>
...
<?php if(!isset($_SESSION['user'])): ?>
                            ...
                            <li><a class="dropdown-item" href="../Customer profile/customer_profile.php">My Profile</a>
                            </li>
                    ...
                    <li class="nav-link-item"><a href="../Customer profile/Customer_cart.php"><img
                                src="../assets/images/icons/shopping-cart.png" id="topIcons" alt="">Cart</a></li>
                    <li class="nav-link-item"><a href="../Sign Up/trader_signup.php"><img
                                src="../assets/images/icons/store.png" id="topIcons" alt="">Become a trader</a></li>
                </ul>
            </div>
                            ...
                            <li>
                                ...
                                <ul class="drop-menu">
                                    <li><a class="dropdown-item"
                                            href="../Shop_category/buchters_category.php">Buchters</a></li>
