...
CREATE TABLE Shop(
    ...
    Shop_Name VARCHAR2(30) NOT NULL  UNIQUE,
...
CREATE TABLE Category(
    ...
    Category_Type VARCHAR2(20) NOT NULL  UNIQUE
);
-- ??????????????????????
...
CREATE TABLE Collection_Slot(
    ...
    Collection_Day VARCHAR2(20) CHECK( Collection_Day IN('Wednesday', 'Thursday', 'Friday')) NOT NULL,
...
CREATE TABLE Product(
    ...
    Product_Status VARCHAR2(20) CHECK( Product_Status IN('In stock', 'out of stock','s')) NOT NULL,
...
CREATE TABLE Discount(
    ...
    Discount_Percent VARCHAR2(10) NOT NULL,
...
CREATE TABLE Review(
    ...
    Rating VARCHAR2(10) CHECK( Rating IN('1','2','3','4','5')),
